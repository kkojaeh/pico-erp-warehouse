...
@ToString
public class WarehouseLevelId implements Serializable {
  ...
  public static WarehouseLevelId from(@NonNull UUID value) {
    return new WarehouseLevelId(value);
  }

  public static WarehouseLevelId generate() {
