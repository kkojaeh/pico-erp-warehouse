...
public abstract class WarehouseRackMapper {
  ...
  public WarehouseRack domain(WarehouseRackEntity entity) {
    return WarehouseRack.builder()
      .id(entity.getId())
      .code(entity.getCode())
      .locationCode(entity.getLocationCode())
      .zone(zoneMapper.domain(entity.getZone()))
      .build();
  }

  @Mappings({
    @Mapping(target = "zone", expression = "java(zoneMapper.entity(domain.getZone()))"),
    @Mapping(target = "createdBy", ignore = true),
    @Mapping(target = "createdDate", ignore = true),
    @Mapping(target = "lastModifiedBy", ignore = true),
    @Mapping(target = "lastModifiedDate", ignore = true)
  })
  public abstract WarehouseRackEntity entity(WarehouseRack domain);
  ...
  @Mappings({
    @Mapping(target = "zone", expression = "java(zoneMapper.map(request.getZoneId()))")
  })
